...
namespace SharpTrader.Tests
{
    class ChartsTest
    {
        ...
        public void TestSmall()
        {
            ...
            var filter1 = new SharpTrader.Indicators.NormalizeToCurrentValue("hp1n", new HighPass<IBaseData>("hp1", 5));
            var filter2 = new SharpTrader.Indicators.NormalizeToCurrentValue("hp2n", new HighPass<IBaseData>("hp2", 15));
            var filter3 = new SharpTrader.Indicators.NormalizeToCurrentValue("hp3n", new HighPass<IBaseData>("hp1", 30));
            ...
            chart.Serialize(@"C:\Projects\sharptraderbots\SharpTrader\SharpTrader.Core\Plotting\chart.json");
