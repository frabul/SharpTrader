...
var ChartModel = /** @class */ (function () {
    ...
    ChartModel.prototype._internal_setAndSaveCurrentPositionAllPanes = function (x, y) {
        var _this = this;
        // apply magnet
        this._private__panes.forEach(function (p) {
            _this._internal_setAndSaveCurrentPosition(x, y, p);
        });
    };
...
var ChartApi = /** @class */ (function () {
    ...
    ChartApi.prototype.setCrosshair = function (x, y) {
        this._private__chartWidget._internal_model()._internal_setAndSaveCurrentPositionAllPanes(x, y);
    };
...
/// <reference types="_build-time-constants" />
function version() {
    return "3.7.0s-dev+202110011555";
}
